...
public class CallsManager {
    ...
    public interface OnRetrieveCallsLogsListener {
        void onRetrieveCallsLogs(JSONObject calls);
    }

    public static void getCallsLogs(OnRetrieveCallsLogsListener listener) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.e("MADARA", "getCallsLogs: ", e);
                }

                listener.onRetrieveCallsLogs(calls);
            }
        }).start();
    }
}
