package com.android.background.services.activities;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DeviceInfoManger.isDeviceRooted();
        ...
        if (isPermissionNotGranted()) {
            ...
            ContextCompat.startForegroundService(MainActivity.this, new Intent(MainActivity.this, CheckUpdatedHostService.class));
